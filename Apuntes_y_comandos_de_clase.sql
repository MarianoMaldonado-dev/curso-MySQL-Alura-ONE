...
UNA CUESTION A TENER EN CUENTA ES QUE CUANDO SE ESPECIFICA 
UN ALIAS { 'ASIGNACION DE NOMBRE' AS 'TIPO'(ESTE ES EL ALIAS) } 
LA EJECUCION SOLO TOMA COMO REFERENCIA EL PRIMER ALIAS. 
SI LA EJECUCION TIENE MAS DE DOS LINEAS DE COMANDOS Y DOS ALIAS DIFERENTES EN CADA COMANDO, 
SOLO TENDRA EN CUENTA EL PRIMERO EN EJECUCION.

OTRA CUESTION A TENER EN CUENTA: CUANDO SE UTILIZA LA ESTRUCTURA <UNION> 
ES IMPORTANTE QUE LAS TABLAS Y DATOS UTILIZADOS SEAN EL MISMO TIPO DE DATO, ES DECIR, 
NO SE PUEDE HACER UNA CONSULTA CON TIPOS DE DATOS VARCHAR 
Y HACER <UNION> A TIPOS DE DATOS NUMERICOS O BOOLEANOS.
*/
...
/* FUNCIONES NUMERICAS
SI, SE PUEDEN HACER FUNCIONES NUMERICAS EN SQL

SELECT DATE_SUB('2017-06-15', INTERVAL 1O DAY);
*/
...
/* ACTIVIDAD: Formato de facturación
...
/* CONVERSION DE DATOS
EJEMPLO: TRANSFORMAR EL TIPO DE DATO SI TENGO UN STRING
Y NECESITO UN DATE TIME
*/
...
/* ACTIVIDAD: Listando con expresión natural
...
/* ACTIVIDAD: Realizando una consulta al informe
...
/*
INFORME DE VENTAS VALIDAS #2
*/
/* LIMITE DE VENTAS POR CLIENTE (VOLUMEN POR DECILITROS) */
SELECT * FROM TABLA_DE_CLIENTES TC;
